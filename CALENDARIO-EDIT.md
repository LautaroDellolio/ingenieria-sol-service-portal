Trabajemos en la vista del Calendario.
	...
	(CORREGIDO)8-El orden de los botones quiero que sea mes - semana - hoy y los botones de navegacion izquierda derecha quiero que esten debajo del calendario

    (CORREGIDO)El punto 3 Esta corregido pero ajusta los estilos del pop up, haz que se vean mas estetico, redondea los bordes etc
   
    El punto 8 igual quiero que separes a los extremos izquierdo o derecho segun corresponda sus botones.

    (CORREGIDO)punto 4 creo que estamos teniendo un error de interpretacion vuelvo explicar el flujo de trabajo. Incorporemos el termino "Hoja de Ruta" Cada hoja de ruta crea detallando el cliente el equipo el tipo de service y la fecha. lo que en este momento estamos llamando nueva visita pero al crear esa visita(con muchos clientes y muchos equipos) para el administrativo sea una unica hoja de ruta. El tecnico si debe visualisar cada equipo de forma individual y de cada uno completar el correspondiente formulario(que luego trabaremos)
