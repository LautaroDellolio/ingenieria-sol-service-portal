      ...
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="bg-surface-container border-b border-outline-variant">
            <th className="p-sm font-label-md text-label-md text-on-surface-variant uppercase font-medium">Parámetro</th>
            <th className="p-sm font-label-md text-label-md text-on-surface-variant uppercase font-medium w-48">Valor Medido</th>
            <th className="p-sm font-label-md text-label-md text-on-surface-variant uppercase font-medium w-24 text-center">Unidad</th>
          </tr>
        </thead>
            ...
            <tr key={definition.key}>
              ...
              <td className="p-sm">
                <input
                  ...
                  className="w-full border border-outline-variant rounded-sm px-sm py-xs font-body-md text-body-md focus:border-primary focus:ring-1"
                />
              </td>
